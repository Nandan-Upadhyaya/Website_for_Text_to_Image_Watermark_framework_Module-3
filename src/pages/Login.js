      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-6">
          <button
            ...
            disabled={loading}
            className="group relative w-full flex justify-center py-3 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
          >
            {loading ? (
          ...
          <div>
            ...
            >
              {loading ? (
                ...
                <LockClosedIcon className="h-5 w-5 text-white mr-2" aria-hidden="true" />
              )}
